...
Revision ID: 49a875651ae0
Revises: 
Create Date: 2026-02-15 22:22:06.774925
...
def upgrade() -> None:
    ...
    sa.Column('security_question', sa.Enum('MOTHER_MAIDEN_NAME', 'CHILDHOOD_FRIEND', 'FAVORITE_COLOR', 'BIRTH_CITY', 'FIRST_SCHOOL', name='securityquestionschema'), nullable=False),
    ...
    sa.Column('otp_expiary_time', postgresql.TIMESTAMP(timezone=True), nullable=True),
